...
def name_handler(message):
    ...
    url = f"{HOSTER_BASE_URL.rstrip('/')}/{quote(slug)}" if HOSTER_BASE_URL else ""
    ...
    bot.send_message(
        ...
        f"🌐 Suggested URL:\n<code>{url}</code>\n\n" if url else "🌐 <b>Render URL:</b> assigned by Render after deployment.\n\n"
...
# The Telegram polling bot and the HTTP server run in the same process.
